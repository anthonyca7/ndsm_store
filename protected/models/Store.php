 ...
 * @property User[] $users
 */
class Store extends CustomActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'comments' => array(self::HAS_MANY, 'Comment', 'school_id'),
			'items' => array(self::HAS_MANY, 'Item', 'school_id'),
			'reservations' => array(self::HAS_MANY, 'Reservation', 'school_id'),
