<?php $tag = $model->unique_identifier ?>
<div class="container">
    <div class="row block">
        <div class="span4">
            <h2>Welcome to <?php echo ucwords($model->name); ?></h2>
            ...
            <a href='<?php echo $this->createUrl("item/index", array("tag"=>$model->unique_identifier)); ?>' class="btn btn-success btn-large">See all items</a>
       </div>
        ...
        <div class="span8">
            ...
            <div id="register" class="modal hide fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <form class="form-horizontal well" id="user-form" action="<?php echo $this->createUrl("user/register", array("tag"=>$model->unique_identifier)); ?>" method="post">
